...
#Config.create(question: "When creating an expense receipt, what account do you want to use to classify 'Commission'?", class_name: "Account") 
#Config.create(question: "When creating an expense receipt, what account do you want to use to classify 'Refund Commission'?", class_name: "Account") 
#Config.create(question: "When creating an expense receipt, what account do you want to use to classify 'FBAPerOrderFulfillmentFee'?", class_name: "Account") 
#Config.create(question: "When creating an expense receipt, what account do you want to use to classify 'Commission'?", class_name: "Account") 
#Config.create(question: "When creating an expense receipt, what account do you want to use to classify 'Commission'?", class_name: "Account") 
#Config.create(question: "When creating an expense receipt, what account do you want to use to classify 'Commission'?", class_name: "Account") 
#Config.create(question: "When creating an expense receipt, what account do you want to use to classify 'Commission'?", class_name: "Account") 
